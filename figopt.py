...
def audit(path):
    ...
    if nfil > 1:
        say(WARN, f"{nfil} филамента: башня очистки "
            ...
            "решать нарезкой обоих вариантов, а не правилом. На A1 башня обычно "
            "проигрывает: основной расход уходит не в неё, а в отходы при смене "
            "филамента, и башня ложится сверху — своим пластиком и своим временем, "
            "а промывка при этом не сокращается. "
